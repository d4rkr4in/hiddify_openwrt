...
opkg install curl nano unzip xz-utils kmod-tun ipset kmod-ipt-ipset luci-theme-openwrt-2020 
...
echo "Cron: check_hiddify — каждые 2 мин, get_cidr4 — 04:00, reboot — 05:00."
