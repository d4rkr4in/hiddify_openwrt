...
wget -O /tmp/HiddifyCli.tar.gz https://github.com/hiddify/hiddify-core/releases/download/v4.0.4/hiddify-core-linux-arm64.tar.gz
tar -xvzf /tmp/HiddifyCli.tar.gz -C /tmp  
mv /tmp/hiddify-core-linux-arm64/hiddify-core /usr/bin/HiddifyCli  
...
wget -O tun2socks-linux-arm64.zip \
     --tries=5 \
     --timeout=5 \
